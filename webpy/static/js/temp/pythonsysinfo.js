...
function refreshVitals(xml) {
    var hostname = "", ip = "", kernel = "", distro = "", icon = "", uptime = "", users = 0, loadavg = "", total = "", machinemodel = "";
    $("Model", xml).each(function getModel(id) {
        machinemodel = $(this).attr("Machinemodel");
        $("#s_model").html(machinemodel);
    });
    $("Vitals", xml).each(function getVitals(id) {
        ...
        $("#s_distro").html("<img src='/static/theme/redmond/images/gfx/images/" + icon + ".png" + "' alt='Icon' height='16' width='16' style='vertical-align:middle;' />&nbsp;" + distro);
    ...
    $("Memory", xml).each(function getMemory(id) {
        ...
        $("#s_size").html((parseFloat(total)/1024/1024/1024).toFixed(2) + 'GB');
        $("#s_type").html("FT1500A");
    });
}
